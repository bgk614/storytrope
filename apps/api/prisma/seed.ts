...
// Trope names/descriptions are curated; everything else (title, author, description,
// cover, dates) is pulled from the real Open Library dump so the seed data reads like
// an actual catalog instead of placeholder text.

const tropes = [
  {
    name: 'Chosen One',
    description:
      'A seemingly ordinary protagonist turns out to be destined to save the world.',
  },
  {
    name: 'Orphan Hero',
    description:
      'The protagonist lost their parents early in life, which shapes their journey.',
  },
  {
    name: "Mentor's Death",
    description:
      "The protagonist's guiding mentor is killed partway through the story, forcing them to grow up fast.",
  },
  {
    name: 'Hidden Royalty',
    description:
      'A character believed to be common-born turns out to have royal or noble blood.',
  },
  {
    name: 'Anti-Hero',
    description:
      'A morally grey protagonist who blurs the line between hero and villain drives the story.',
  },
  {
    name: 'Enemies to Lovers',
    description:
      'Two characters who start out as rivals or adversaries gradually fall in love.',
  },
  {
    name: 'Love Triangle',
    description:
      'Two people compete for the affection of a single love interest.',
  },
  {
    name: 'Insta-Love',
    description:
